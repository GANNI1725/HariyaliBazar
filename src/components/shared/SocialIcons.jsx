...
export const FacebookIcon = ({ size = 18, className = '' }) => (
  <svg {...baseProps} width={size} height={size} className={className} aria-hidden fill="currentColor">
    <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" />
  </svg>
)

export const InstagramIcon = ({ size = 18, className = '' }) => (
  <svg {...baseProps} width={size} height={size} className={className} aria-hidden>
